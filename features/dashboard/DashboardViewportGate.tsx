...
export function DashboardViewportGate({
  children,
}: {
      ...
      <Panel className="mt-[clamp(1rem,4vw,3rem)] flex flex-1 flex-col justify-center px-[clamp(1.5rem,6vw,3rem)] py-[clamp(2rem,8vh,4rem)]">
        <div className="mx-auto max-w-[52ch] text-center">
          <h1 className="text-xl leading-6 font-bold text-neutral-800">
            Semblocks needs a larger desktop viewport.
          </h1>

          <p className="mt-6 rounded-base border border-stroke bg-white/30 px-3 py-2 text-sm leading-5 text-neutral-800">
